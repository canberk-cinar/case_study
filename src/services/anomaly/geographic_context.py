...
domestic 2.40% (4.26x). A third category, addr2 MISSING (11.13% of rows), carries an
...
weekend_context.py / trusted_entity_context.py:
  - apply_geographic_policy_adjustment (label-free, naive/operational policy): a fixed boost for
    ...
    the gap the fraud-calibrated function below reveals: missing data is the single
