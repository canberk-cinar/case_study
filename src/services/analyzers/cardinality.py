...
distinction plan.md calls out explicitly: a high-cardinality column is not automatically a "bad"
column to drop — some of them are exactly the aggregation keys a later anomaly-detection stage
