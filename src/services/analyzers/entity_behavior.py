...
aggregation rather than encode away. This is that aggregation put to use: per-card1 behavior —
transaction count, how many distinct regions/devices it operates from, how variable its spending
is, how fast consecutive transactions come in. These are exactly the signals a later
